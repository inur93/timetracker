...
class TimeOverview extends Component {
    ...
    constructor(props) {
        super(props);
        this.uiStore = new TimeOverviewUiStore(props.timeRegistrationStore);
    }
            ...
            <Page title="Time overview">
                ...
                <div className="button-row">
                    <InputGroup className="search-button">
                        <InputGroupAddon addonType="prepend">
                            ...
                            <UncontrolledTooltip placement="left" target="btn-search-everything">
                                Check this if you want to search all time registrations
                                            </UncontrolledTooltip>
                        </InputGroupAddon>
                    ...
                    <ButtonGroup className="float-right">
                        <Button color="primary" onClick={() => this.uiStore.showCreateModal = true}>Register time</Button>
                    </ButtonGroup>
                </div>
                <div className="button-row">
                    <ButtonGroup>
                        ...
                        <Button outline color="primary" disabled={includesToday} onClick={navigateToday}>
                            <IconToday />
                        </Button>
...
export default inject([stores.timeRegistrationStore])(observer(TimeOverview));
...
class TimeOverviewUiStore {
    ...
    store;
    constructor(timeRegistrationStore) {
    ...
    get overviewTitle() {
        let from = format(this.store.from, "MMMM YYYY", { locale: daLocale });
        let to = format(this.store.to, "MMMM YYYY", { locale: daLocale });
